...
def main():
    parser = argparse.ArgumentParser(description="Run the candidate_generation ablation.")
    add_common_args(parser)
    parser.add_argument("--output-dir", default=None)
    parser.add_argument("--candidate-artifact", default=None)
    args, extra = parser.parse_known_args()
    cmd = ablation_command(load_config(args.config), "candidate_generation", scenario=args.scenario,
